...
export default function TestimonialsFixed() {
    ...
    <section className="testimonials py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 reveal-up">
          {/* FIXED: Flexible container with minimum height */}
          <div
            className="mb-8 w-full max-w-6xl mx-auto flex items-center justify-center"
            style={{
              minHeight: "80px",
          ...
          >
            {typeof window !== "undefined" ? (
              ...
              <h1 className="text-3xl md:text-5xl font-bold gradient-text text-center">Student Success Stories</h1>
            )}
          </div>
